...
5. PAYMENT & SUBSCRIPTIONS: By enrolling in the Services, you agree to pay all applicable fees according to your selected payment plan, whether monthly or annually. Pricing is currently: Monthly Plan – $99/month; Annual Plan – $89/month, billed annually in advance. Fees are subject to change with 30 days' notice. Payment is accepted via credit card, debit card, FSA, HSA, HRA, or other accepted payment methods. You authorize us to automatically charge your payment method on file for recurring billing. A 10-day money-back guarantee is available to first-time users. After the initial period, refunds are discretionary and handled on a case-by-case basis.
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-neutral-700 max-w-2xl mx-auto">
            Choose the plan that fits your needs. No hidden fees. 10-day money-back guarantee.
          </p>
        </div>
        ...
        <div className="mt-12 flex flex-col items-center">
          <div className="flex items-center gap-4 mb-2">
            ...
            <span className="text-neutral-700 font-medium">10-day money-back guarantee</span>
          </div>
